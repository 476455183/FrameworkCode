...
//%%% default diameter
CGFloat const RKNotificationHubDefaultDiameter = 20;//30;
...
- (void)setCircleAtFrame:(CGRect)frame
{
    ...
    //[countLabel setFont:[UIFont fontWithName:@"HelveticaNeue" size:13]];
    [countLabel setFont:[UIFont systemFontOfSize:self.fontOfSize]];
